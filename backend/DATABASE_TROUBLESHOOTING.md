...
```env
PORT=3001
DATABASE_URL=postgresql://YOUR_DB_USER:YOUR_DB_PASSWORD@YOUR_HOST:5432/postgres
...
- Password: your DB password (special characters must be URL-encoded)
...
```bash
psql "postgresql://YOUR_DB_USER:YOUR_DB_PASSWORD@YOUR_HOST:5432/postgres?sslmode=require"
```
...
const client = new Client({
  connectionString: 'postgresql://YOUR_DB_USER:YOUR_DB_PASSWORD@YOUR_HOST:5432/postgres',
