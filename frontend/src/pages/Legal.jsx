        ...
        >
          ...
          <div style={{ display: "grid", gap: 16 }}>
            ...
            <Section id="shipping" title="4. Shipping & Delivery">
              <p>
                We ship across Côte d'Ivoire and can arrange regional shipping on request. Delivery
            ...
            <Section id="law" title="12. Governing Law">
              <p>
                These Terms are governed by the laws applicable in Côte d'Ivoire, without regard to its
                conflict of law rules. Disputes shall be handled by the competent courts in Côte d'Ivoire.
              </p>
            </Section>
