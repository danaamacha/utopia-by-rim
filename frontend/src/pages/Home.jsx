...
function BestSellers() {
  ...
  const items = [
    ...
    { image: "/best/best3.jpg", name: "Ocean Table", price: 420 },
    { image: "/best/best5.jpg", name: "Forest Coasters", price: 42 },
  ];
    ...
    <section style={{ background: "#8d7f96", padding: "48px 20px 70px" }}>
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        ...
        >
          ...
          >
            {items.map((p) => (
              <Link key={p.name} to="/shop" style={{ textDecoration: "none", color: "inherit" }}>
                <BestSellerCard {...p} />
              </Link>
            ))}
          </div>
