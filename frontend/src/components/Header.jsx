...
export default function Header() {
  ...
  const accountHref = !user ? "/login" : isAdmin ? "/admin" : "/account/profile";
  const accountTitle = !user ? "Login / Register" : isAdmin ? "Admin dashboard" : "Account";
      ...
      <>
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
            <button
              ...
              title={accountTitle}
              onClick={() => setOpen(true)}
              style={{ background: "transparent", border: "none", color: "#fff", padding: 8, display: "inline-flex", alignItems: "center", cursor: "pointer" }}
            >
              <UserIcon />
            </button>
            <Link
              to="/cart"
              title="Cart"
              style={{ color: "#fff", display: "inline-flex", alignItems: "center", padding: 8 }}
            >
              <CartIcon />
            </Link>
          </div>
        ...
        >
          ...
          <div style={{ marginTop: "auto", paddingTop: 24, display: "grid", gap: 8 }}>
            {user ? (
              <>
                <div style={{ fontSize: 13, color: "rgba(255,255,255,0.7)", paddingBottom: 4 }}>
                ...
                <button
                  ...
                  style={{
                    height: 44, borderRadius: 12, border: "1px solid rgba(255,255,255,0.4)",
